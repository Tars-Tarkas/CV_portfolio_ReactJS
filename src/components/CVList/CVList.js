                ...
                return(
                  <div key={index} className='about__contacts__block'>
                    ...
                    <ul className='about__contacts'>
                      ...
                      <li className='about__contacts-text'><i className='icon-email' /><a href={item.mail} target="_blank" rel='noreferrer'>{item.mail.slice(7)}</a></li>
                      <li className='about__contacts-text'><i className='icon-telegram' /><a href={item.telegram} target="_blank" rel='noreferrer'>Telegram</a></li>
                      <li className='about__contacts-text'><i className='icon-github' /><a href={item.github} target="_blank" rel='noreferrer'>Github</a></li>
                      <li className='about__contacts-text'><i className='icon-linkedin' /><a href={item.linkedin} target="_blank" rel='noreferrer'>Linkedin</a></li>
                    </ul>
                  </div>
                )
              })}
                ...
                <table key={index} className='info__experience__table'>
                  ...
                  <tr>                
                   <td className='info__experience__year'>{item.year}</td>
                    <td className='info__experience__organization'>{item.organization}                      
                      <div className='info__experience__position'>Должность: {item.position}</div>
                      <div className='info__experience__description'>{item.description}</div>                      
                    </td>                    
                   </tr>                 
                   </thead>
                </table>
              ...
              return(              
                <table key={index}>
                  ...
                  <tr>              
                    ...
                    <td className='info__education__institution'>{item.institution}
                    <div className='info__education__department'>Кафедра: {item.department}</div>
                    <div className='info__education__specialization'>Специальность: {item.specialization}</div>
                    </td>
                  </tr>
                  </thead>
                </table>              
