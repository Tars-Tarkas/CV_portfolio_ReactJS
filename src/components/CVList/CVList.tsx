...
const CVList: React.FC = (): JSX.Element => {
  const { CV, loading }: { CV: cvtype.RootObject[]; loading: boolean } =
    useSelector((state: cvtype.RootObject) => state);
  ...
  return (
    ...
    //           {data.hardskils.map((item: any, index: number) => {
    ...
    //           {data.hobby.map((item: any, index: number) => {
    //             return <li key={index}>{item}</li>;
    //           })}
    //         </ul>
    //       </div>
    ...
    //         {data.person.map((item: any, index: number) => {
    //           return (
    //             <div key={index}>
    ...
    //         {data.position.map((item: any, index: number) => {
    //           return (
    //             <div key={index}>
